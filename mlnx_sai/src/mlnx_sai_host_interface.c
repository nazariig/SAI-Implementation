...
const mlnx_trap_info_t                    mlnx_traps_info[] = {
    ...
    { SAI_HOSTIF_TRAP_TYPE_PIPELINE_DISCARD_ROUTER, 0, { 0 }, SAI_PACKET_ACTION_DROP, "Discard Router",
     MLNX_TRAP_TYPE_REGULAR },
#ifdef PTP
    { SAI_HOSTIF_TRAP_TYPE_CUSTOM_EXCEPTION_RANGE_BASE, 4, { SX_TRAP_ID_PTP_EVENT, SX_TRAP_ID_PTP_GENERAL, SX_TRAP_ID_PTP_ING_EVENT, SX_TRAP_ID_PTP_EGR_EVENT }, SAI_PACKET_ACTION_TRAP, "PTP",
     MLNX_TRAP_TYPE_REGULAR },
#endif
